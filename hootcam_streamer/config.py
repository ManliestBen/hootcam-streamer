...
_DEFAULTS = {
    ...
    "rtsp_port": 8554,
    "backend": "rpicam-vid",  # "rpicam-vid" or "picamera2" (use picamera2 for dual-camera on Pi 5)
...
def load_config(path: Path | None = None) -> dict[str, Any]:
    ...
    try:
        ...
        return dict(_DEFAULTS)
    out = dict(_DEFAULTS)
    for key in ("mediamtx_path", "rtsp_port", "mediamtx_rtp_port", "kill_leftover_processes", "backend"):
        if key in data:
            out[key] = data[key]
